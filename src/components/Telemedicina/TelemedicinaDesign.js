                ...
                <div className='informacion-telemedicina'>
                    ...
                    <div className='documento-telemedicina'>
                        ...
                        <div className='pasos-telemedicina'>
                            <div className='paso1'>
                                <FontAwesomeIcon icon={faPhoneVolume} className='FontAwseomeTelemedicina telephone'/>
                                <h2>Comuniquese con nosotros</h2>
                                <p>Será un placer atenderlo</p>
                            </div>
                            <div className='paso2'>
                                <FontAwesomeIcon icon={faCalendarAlt} className='FontAwseomeTelemedicina calendar'/>
                                <h2>Agende una cita</h2>
                                <p>Aquí eligirá el metodo mediante el cual quiere que nos pongamos en contacto con usted</p>
                            </div>
                            <div className='paso3'>
                                <FontAwesomeIcon icon={faCreditCard} className='FontAwseomeTelemedicina credit'/>
                                <h2>Realice el pago del servicio</h2>
                                <p>Le indicaremos formas de pago y pediremos dirección de envío de sus productos</p>
                            </div>
                            <div className='paso4'>
                                <FontAwesomeIcon icon={faShippingFast} className='FontAwseomeTelemedicina truck'/>
                                <h2>Envío de productos</h2>
                                <p>Recibirá sus productos en la comodidad de su casa</p>
                            </div>
                            <div className='paso5'>
                                <FontAwesomeIcon icon={faUserMd} className='FontAwseomeTelemedicina doctor'/>
