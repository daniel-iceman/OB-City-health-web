...
function Carlos() {
    ...
    const [speach_1_Pac] = useState('Cuando me casé, hace 18 años, comencé a ganar peso poco a poco; En la medida en que lo hacía, dejé de hacer deporte. Un día sufrí lesiones deportivas y cada día dejé de hacer menos ejercicio hasta que lo dejé por completo. Además mis hábitos alimenticios fueron terribles por mucho tiempo.')
