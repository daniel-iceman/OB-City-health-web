...
function JoseJuan() {
    ...
    const [speach_1_Pac] = useState('Tenía años con obesidad y siempre le di vueltas para atenderme. Tenía problemas con mi presión y mi colesterol y cuando llegué con el doctor tuvo que darme medicamento para controlarlos. Roncaba por las noches y seguido me despertaba con falta de aire.  Nunca antes había estado en una dieta y me preocupaba que por mi ritmo de vida no pudiera llevarla.')
    const [speach_2_Pac] = useState('En mi trabajo no tenía horarios para comer y eso no me ayudaba en nada a mi peso, en lugar de bajar seguía subiendo, hasta que llegué con el doctor Díaz y empezamos el tratamiento. Me di cuenta lo equivocado que estaba ya que comía muchas cosas que pensaba eran sanas y era todo lo contario.  Aprendí mucho durante el tratamiento y eso me ayudará a no volver a subir.')
    const [speach_3_Pac] = useState('Aunque inicié escéptico, hice todo lo que el doctor me dijo y al pasar la semanas mi presión mejoró al grado de que me quitó el medicamento que tomaba y mi colesterol llego a niveles normales.  Empecé a usar ropa que nunca pense poder ponerme y eso me dio mayor seguridad.   Hoy me siento un hombre nuevo, siento que me quitaron años de encima.')
