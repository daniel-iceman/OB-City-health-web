...
function ProtocoloABC() {
    ...
    const [prfo_3] = useState ('Este método consiste en el consumo de una malteada baja en carbohidratos y rica en proteínas en el desayuno y la cena (Plan Protein 57). Durante la comida consumirá alimentos balanceados, reduciendo la ingesta de carbohidratos. De esta forma, obtendrá resultados más rápidos en la pérdida de grasa corporal y medidas.')
