            ...
            <div className='blogCovid'>
                ...
                <div className='parrafo-2-covid'>
                    <div className='texto-covid'>
                        <p>
                            COVID-19 es una enfermedad provocada por un coronavirus, se transmite principalemente cuando la saliva y/o fluido nasal de una persona infectada entran en contacto con ojos, nariz y boca de una persona sana.  Así mismo tambien se puede contraer cuando existe contacto de la manos con superficies contaminadas y su posterior inoculación a ojos, nariz y boca. <br/> 
                        </p>                            
                        <p>
