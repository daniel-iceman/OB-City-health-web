...
import SocialMediaEnchiladasLechuga from './SocialMediaEnchiladasLechuga';

function EnchiladasDeLechuga({
    titulo,
    ingrediente_1,
    ingrediente_2,
    ingrediente_3,
            ...
            <div className='contenedor-informacion-receta'>
                ...
                <div className='imagen-propiedades'>
                    <div className='imagen-receta'>
                        <div className='foto enchilada-de-lechuga'></div>
                    </div>
...
export default EnchiladasDeLechuga
