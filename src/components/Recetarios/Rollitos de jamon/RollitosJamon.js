...
import SocialMediaRollitosJamon from './SocialMediaRollitosJamon';

function RollitosJamon({
    titulo,
    ingrediente_1,
    ingrediente_2,
    ingrediente_3,
            ...
            <div className='contenedor-informacion-receta'>
                ...
                <div className='imagen-propiedades'>
                    <div className='imagen-receta'>
                        <div className='foto rollitos-de-jamon'></div>
                    </div>
