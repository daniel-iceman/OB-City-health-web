...
import SocialMediaTortillaVegetales from './SocialMediaTortillaVegetales';

function TortillaDeVegetales({
    titulo,
    ingrediente_1,
    ingrediente_2,
    ingrediente_3,
            ...
            <div className='contenedor-informacion-receta'>
                ...
                <div className='imagen-propiedades'>
                    <div className='imagen-receta'>
                        <div className='foto tortilla-de-vegetales'></div>
                    </div>
...
export default TortillaDeVegetales
