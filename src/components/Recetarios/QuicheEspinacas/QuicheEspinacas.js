...
import SocialMediaQuicheEspinacas from './SocialMediaQuicheEspinacas';

function QuicheEspinacas({
    titulo,
    ingrediente_1,
    ingrediente_2,
    ingrediente_3,
            ...
            <div className='contenedor-informacion-receta'>
                ...
                <div className='imagen-propiedades'>
                    <div className='imagen-receta'>
                        <div className='foto quiche-de-espinacas'></div>
                    </div>
...
export default QuicheEspinacas
